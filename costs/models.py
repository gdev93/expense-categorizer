...
class CostConfiguration(models.Model):
    ...
    earning_multiplier_percentage = models.DecimalField(max_digits=10, decimal_places=2,
                                                        help_text="Percentage of total cost to earn per token",
                                                        default=25.0)
    minimum_earnings = models.DecimalField(max_digits=10, decimal_places=2,
                                           help_text="Minimum amount of earnings to be considered", default=0.10)
...
class ApiUsageLog(models.Model):
    ...
    final_earning = models.DecimalField(max_digits=12, decimal_places=6, default=0.0)
