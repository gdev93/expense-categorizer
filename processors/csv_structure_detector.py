...
class CsvStructureDetector:
    ...
    def setup_upload_file_structure(self, current_data: list[Transaction], upload_file: UploadFile) -> UploadFile:
        if upload_file.description_column_name and upload_file.date_column_name and (upload_file.income_amount_column_name or upload_file.expense_amount_column_name):
            return upload_file
